 ...
 void TaskDistance::loop()
 {
    ...
    if(Distance < activeDistance && !IsScore){
        ...
        if(!Shake){
          Total = Total + 1;
          lcd.setCursor(0,0);  
          lcd.print("Total:"); lcd.print(Total,DEC);
          IsShoot = true ;
        }
        digitalWrite(LED, HIGH);
        IsScore = true ; 
        lcd.setCursor(0,1);  lcd.print("Score:"); lcd.print(Score,DEC);
        // lcd.setCursor(10,0);  Rate = Score/Total  ;lcd.print(Rate);
        sleep(2000);
        IsScore = false ; IsShoot = false ;
    }else{
